...
<div class="container mb-5 pb-5">
  <div class="row">
    <div class="col-lg-11 offset-lg-1">
      ...
      <div class="row mb-3">
        <a class="col-lg-8 mt-3" href="sollicitatie_vacature.php?expertise=<?php echo $page_content['expertise']; ?>&ervaring=Senior&werktijden=Fulltime, 40 uur&salaris=€5000 - hoger"><div>
          <p>Nederland</p>
          <h3>Senior <?php echo $page_content['expertise']; ?> functie</h3>
          ...
          <a class="col-lg-8 mt-3" href="sollicitatie_vacature.php?expertise=<?php echo $page_content['expertise']; ?>&ervaring=Junior&werktijden=Parttime, 36 uur&salaris=€2500 - €2500"><div>
          <p>Nederland</p>
          <h3>Junior <?php echo $page_content['expertise']; ?> functie</h3>
          <p>Afdeling <?php echo $page_content['expertise'];; ?></p>
          <p>Parttime, 36 uur</p>
          <hr>
        </div></a>
          ...
          <a class="col-lg-8 mt-3" href="sollicitatie_vacature.php?expertise=<?php echo $page_content['expertise']; ?>&ervaring=Medior&werktijden=Fulltime, 40 uur&salaris=€3000 - €5000"><div>
          <p>Nederland</p>
          <h3>Medior <?php echo $page_content['expertise']; ?> functie</h3>
          <p>Afdeling<?php echo $page_content['expertise']; ?></p>
          <p>Fulltime, 40 uur</p>
          <hr>
        </div></a>
